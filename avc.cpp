		...
		for(int countCol = 0; countCol < 320; countCol++){
			...
			if (lineCount < 20 && vertLineCount < 20 && err == 0 && prevErr < 1 && corner == 0){
				...
				sleep1(1000);
					...
					sleep1(400);
					return 0;
			} else if ((lineCount >= 230 && (err < 1 || err > 5.25) && (lineCount - prevLineCount) < 50 && xroadBool == 1 && corner == 0 && (err - prevErr < 1 && err - prevErr > -1)) || (lineCount > 270 && corner == 0) || (lineCount > 302 && (prevErr < 3.85 && prevErr > -3.85)) ){
